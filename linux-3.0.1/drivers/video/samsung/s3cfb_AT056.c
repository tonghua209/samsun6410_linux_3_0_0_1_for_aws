...
#define S3CFB_VRES_VIRTUAL	960	/* line cnt       y resolution */  //Do not  change 960 to 480 .I think that 480 is right in the driver of LCD,but double frambuffer 
// in multimediatest do not use if change that
#define S3CFB_HRES_OSD		640	/* horizon pixel  x resolition */
#define S3CFB_VRES_OSD		480	/* line cnt       y resolution */

#define S3CFB_VFRAME_FREQ     	103	/* frame rate freq */
...
{
	printk(KERN_INFO "LCD TYPE :: 5.6inch lcd will be initialized\n");
