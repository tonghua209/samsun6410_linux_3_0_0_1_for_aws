...
#define S3CFB_VRES_VIRTUAL	1200	/* line cnt       y resolution */ //Do not  change 1200 to 600 .I think that 600 is right in the driver of LCD,but double
//frambuffer in multimediatest do not use if change that
...
#define S3CFB_VFRAME_FREQ     	48	/* frame rate freq */ //20131120 xyz changed for display jitter
...
void s3cfb_init_hw_80(void)
{
	printk(KERN_INFO "LCD TYPE :: 8||10 inch lcd will be initialized\n");
