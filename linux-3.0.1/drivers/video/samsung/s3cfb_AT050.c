/*
 * drivers/video/s3c/s3cfb_at050.c
 *
...
#define S3CFB_VRES_VIRTUAL	960	/* line cnt       y resolution */ //Do not  change 960 to 480 .I think that 480 is right in the driver of LCD,but double
...
#define S3CFB_VFRAME_FREQ     	 68	/* frame rate freq */ 
...
void s3cfb_init_hw_50(void)
{
	printk(KERN_INFO "LCD TYPE :: 5inch lcd (800*480) will be initialized\n");
